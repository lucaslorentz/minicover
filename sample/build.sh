...
dotnet minicover report --workdir ../coverage --threshold 90

# Generate other reports
dotnet minicover htmlreport --workdir ../coverage --threshold 90
dotnet minicover xmlreport --workdir ../coverage --threshold 90
dotnet minicover opencoverreport --workdir ../coverage --threshold 90
dotnet minicover cloverreport --workdir ../coverage --threshold 90
