...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.ConstructorWithExistingTryFinally/Class""
IL_000f: ldstr "".ctor""
...
.try
{
    ...
    .try
    {
        .try
        {
            ...
            IL_0039: ldloc.0
            IL_003a: ldc.i4.3
            IL_003b: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
            IL_0040: ldstr ""Test""
        ...
        catch System.Exception
        {
            IL_004b: ldloc.0
            IL_004c: ldc.i4.4
            IL_004d: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
            IL_0052: pop
            IL_0053: nop
            IL_0054: ldloc.0
            IL_0055: ldc.i4.5
            IL_0056: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
            IL_005b: ldarg.0 // this
            IL_005c: ldc.i4.1
            IL_005d: stfld System.Boolean MiniCover.Core.UnitTests.Instrumentation.ConstructorWithExistingTryFinally/Class::CatchWasCalled
            IL_0062: nop
    ...
    finally
    {
        ...
        IL_0068: ldloc.0
        IL_0069: ldc.i4.6
        IL_006a: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
        IL_006f: ldarg.0 // this
        IL_0070: ldc.i4.1
        IL_0071: stfld System.Boolean MiniCover.Core.UnitTests.Instrumentation.ConstructorWithExistingTryFinally/Class::FinallyWasCalled
        IL_0076: nop
        IL_0077: endfinally
    }
...
finally
{
    IL_007a: nop
    IL_007b: ldloc.0
    IL_007c: callvirt System.Void MiniCover.HitServices.MethodScope::Dispose()
    IL_0081: endfinally
}
IL_0082: ret
";
