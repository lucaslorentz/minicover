...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.If/Class""
...
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.If/Class",
                    FullName = "System.Boolean MiniCover.Core.UnitTests.Instrumentation.If/Class::Method(System.Int32)",
                    Name = "Method"
                },
                StartColumn = 17,
                StartLine = 13
