...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.Or/Class""
...
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.Or/Class",
                    FullName = "System.Boolean MiniCover.Core.UnitTests.Instrumentation.Or/Class::Method(System.Boolean,System.Boolean)",
                    Name = "Method"
                },
                StartColumn = 17,
                StartLine = 13
