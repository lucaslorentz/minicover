...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.IfInlineNested/Class""
...
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.IfInlineNested/Class",
                    FullName = "System.Boolean MiniCover.Core.UnitTests.Instrumentation.IfInlineNested/Class::Method(System.Int32)",
                    Name = "Method",
                },
                StartColumn = 17,
                StartLine = 13,
