...
namespace MiniCover.Core.UnitTests.Instrumentation
{
    public class Using : BaseTest
    {
        ...
        public override string ExpectedIL => @".locals init (System.IO.MemoryStream stream, System.Byte[] V_1, MiniCover.HitServices.MethodScope V_2, System.Byte[] V_3)
IL_0000: ldstr ""/tmp""
IL_0005: ldstr ""MiniCover.Core.UnitTests""
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.Using/Class""
...
.try
{
    ...
    .try
    {
        ...
        IL_002a: ldloc.2
        IL_002b: ldc.i4.2
        IL_002c: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
        IL_0031: ldloc.0
        IL_0032: ldc.i4.0
...
finally
{
    IL_0058: nop
    IL_0059: ldloc.2
    IL_005a: callvirt System.Void MiniCover.HitServices.MethodScope::Dispose()
    IL_005f: endfinally
}
IL_0060: ldloc.3
IL_0061: ret
