...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.Switch/Class""
...
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.Switch/Class",
                    FullName = "System.Int32 MiniCover.Core.UnitTests.Instrumentation.Switch/Class::Method(System.Int32)",
                    Name = "Method"
                },
                StartColumn = 17,
                StartLine = 13
