...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.IfInline/Class""
...
.try
{
    ...
    IL_0032: ldloc.1
    IL_0033: ldc.i4.3
    IL_0034: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
    IL_0039: ldc.i4.1
    IL_003a: stloc.0
...
finally
{
    IL_0041: nop
    IL_0042: ldloc.1
    IL_0043: callvirt System.Void MiniCover.HitServices.MethodScope::Dispose()
    IL_0048: endfinally
}
IL_0049: ldloc.2
IL_004a: ret
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.IfInline/Class",
                    FullName = "System.Boolean MiniCover.Core.UnitTests.Instrumentation.IfInline/Class::Method(System.Int32)",
                    Name = "Method",
                },
                StartColumn = 17,
                StartLine = 13,
