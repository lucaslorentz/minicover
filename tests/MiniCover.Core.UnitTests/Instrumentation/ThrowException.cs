...
{
    public class ThrowException : BaseTest
    {
        public class Class
        {
        ...
        public ThrowException() : base(typeof(Class).GetMethod(nameof(Class.Method)))
        {
        }
        ...
        public override string ExpectedIL => @".locals init (MiniCover.HitServices.MethodScope V_0, System.Int32 V_1)
IL_0000: ldstr ""/tmp""
IL_0005: ldstr ""MiniCover.Core.UnitTests""
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.ThrowException/Class""
...
finally
{
    IL_003c: nop
    IL_003d: ldloc.0
    IL_003e: callvirt System.Void MiniCover.HitServices.MethodScope::Dispose()
    IL_0043: endfinally
}
IL_0044: ldloc.1
IL_0045: ret
