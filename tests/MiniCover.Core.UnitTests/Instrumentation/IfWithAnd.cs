...
IL_000a: ldstr ""MiniCover.Core.UnitTests.Instrumentation.IfWithAnd/Class""
...
.try
{
    ...
    IL_0043: ldloc.2
    IL_0044: ldc.i4.4
    IL_0045: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
    IL_004a: ldc.i4.1
    IL_004b: stloc.1
    IL_004c: br.s IL_0059
    IL_004e: ldloc.2
    IL_004f: ldc.i4.5
    IL_0050: callvirt System.Void MiniCover.HitServices.MethodScope::Hit(System.Int32)
    IL_0055: ldc.i4.0
    IL_0056: stloc.1
...
finally
{
    IL_005d: nop
    IL_005e: ldloc.2
    IL_005f: callvirt System.Void MiniCover.HitServices.MethodScope::Dispose()
    IL_0064: endfinally
}
IL_0065: ldloc.3
IL_0066: ret
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.Core.UnitTests.Instrumentation.IfWithAnd/Class",
                    FullName = "System.Boolean MiniCover.Core.UnitTests.Instrumentation.IfWithAnd/Class::Method(System.Int32)",
                    Name = "Method"
                },
                StartColumn = 17,
                StartLine = 13
