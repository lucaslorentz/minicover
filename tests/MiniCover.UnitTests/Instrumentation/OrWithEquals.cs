...
IL_000a: ldstr ""MiniCover.UnitTests.Instrumentation.OrWithEquals/Class""
...
finally
{
    IL_0046: nop
    IL_0047: ldloc.1
    IL_0048: callvirt System.Void MiniCover.HitServices.HitService/MethodContext::Dispose()
    IL_004d: endfinally
}
IL_004e: ldloc.2
IL_004f: ret
";
        ...
        public override InstrumentedSequence[] ExpectedInstructions => new InstrumentedSequence[]
        {
            new InstrumentedSequence
            {
                ...
                {
                    Class = "MiniCover.UnitTests.Instrumentation.OrWithEquals/Class",
                    FullName = "System.Boolean MiniCover.UnitTests.Instrumentation.OrWithEquals/Class::Method(System.Int32)",
                    Name = "Method"
                },
                StartColumn = 17,
                StartLine = 13,
